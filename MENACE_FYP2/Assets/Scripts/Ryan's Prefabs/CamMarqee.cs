...
public class CamMarqee : MonoBehaviour {

	public Texture marqeeGraphics;
	...
	private void OnGUI()
	{
		...
		GUI.DrawTexture(marqueeRect, marqeeGraphics);
	}
	...
	void Update () {
		if (Input.GetMouseButtonDown(0))
		{
			...
			SelectableUnits = new List<GameObject>(GameObject.FindGameObjectsWithTag("SelectableUnits"));
