...
public class TutorialScript : MonoBehaviour {
	...
	void Start () {
		...
		audioFlip = (AudioSource)gameObject.AddComponent<AudioSource> ();
		audioFlip.clip = flipClip;
		audioFlip.loop = false;
		audioFlip.playOnAwake = false;
	}
	...
	public void RightButtonChange(){
		...
		audioFlip.PlayOneShot (flipClip);
